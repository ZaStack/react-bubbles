...
An object that can't be manipulated and can be passed around to allow users to view protected data.

- [x] What steps can you take in your web apps to keep your data secure?

Put sensitive information behind a private route so that only computers with the auth token can access them.

- [x] Describe how web servers work.

They are stored code on physical servers that serve up web apps when called.
...
- [xKs] PM then will count the HW as done by  merging the branch back into master.
